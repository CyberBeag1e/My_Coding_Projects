...
class ResBlock(Layer):
    ...
    def __init__(self,kernelNum,strides=1):
        ...
        as well as reduce half of the tensor's size.
...
class PatternDetection:
    ...
    def dataPrepare(self,proportion=0.5):
        ...
        Therefore, pictures should firstly be divided into a group with patterns 
        and the other group without pattern
        """
        X=self.backgrounds
    ...
    def detect(self,newImg,num_of_sims=1000):
        ...
        ## Get the most likely sub-image with pattern
