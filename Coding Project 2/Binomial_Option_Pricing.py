...
## Define binomial tree from <class list>
class BinomialTree(list):
    def __init__(self):
        '''
    ...
    ## Generate the binomial tree of the specified height
...
## I turned to python 'list' class for help, and defined the 'BinomialTree' class as presented above.
...
class binaryTree(object):
    ...
    def getVal(self, isCall, isEU):
        ...
        ## We mush reversely deduct for values
        ## The logic of calculation is similar as the BinomialTree.valCal(),
